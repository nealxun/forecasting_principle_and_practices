 ...
 * If first argument is of class `ts|, it returns forecasts from automatic ETS algorithm.
 * Methods are available for objects of class `Arima`, `ar`, `HoltWinters`, `StructTS`, etc.
