...
```{r beerf, fig.cap="Forecasts of Australian quarterly beer production.", warnings=FALSE, message=FALSE}
...
```{r djf, fig.cap="Forecasts based on 250 days of the Dow Jones Index.", warnings=FALSE}
