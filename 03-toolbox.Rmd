...
autoplot(eggs) +
  ...
  autolayer(fc2, PI=FALSE, series="Bias adjusted") +
  guides(colour=guide_legend(title="Forecast"))
```
...
```{r DJacf, fig.cap="ACF of the residuals from the naïve method applied to the Dow Jones Index. The lack of correlation suggesting the forecasts are good.", fig.height=3}
