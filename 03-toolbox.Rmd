...
`window` is a useful command

```{r }
beer2 <- window(ausbeer,start=1992,end=c(2007,4))
beer2 <- subset(ausbeer,start=200,end=length(ausbeer))
...
window(USAccDeaths,start=1973,end=c(1974,1))
subset(USAccDeaths,start=2,end=13)
