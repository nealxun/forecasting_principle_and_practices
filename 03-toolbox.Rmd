...
```{r, fig.cap="Residuals from forecasting the Dow Jones Index using the naïve method.", cache=TRUE, warning=FALSE}
...
```{r, fig.cap="ACF of the residuals from the naïve method applied to the Dow Jones Index. The lack of correlation suggesting the forecasts are good.", cache=TRUE, fig.height=3}
...
7. For your retail time series (from Exercises \@ref(ex:graphics))?
