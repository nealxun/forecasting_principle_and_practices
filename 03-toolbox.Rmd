...
beerdf <- cbind(Actual = beer2, 
  ...
  Naïve = naive(beer2, h=11)$mean,
  'Seasonal naïve' = snaive(beer2, h=11)$mean)
autoplot(beerdf) + 
  ggtitle("Forecasts for quarterly beer production") +
  xlab("Year") + ylab("Megalitres") +
  scale_color_manual(values=c('#000000','#1b9e77','#d95f02','#7570b3'),
                     breaks=c("Mean","Naïve","Seasonal naïve"),
...
tmp <- cbind(Data=dj, Mean=djfc1$mean, Naïve=djfc2$mean, Drift=djfc3$mean)
