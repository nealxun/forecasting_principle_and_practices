...
# Plot some forecasts
autoplot(beer2) +
  geom_forecast(meanf(beer2, h=11), plot.conf=FALSE, series="Mean") +
  geom_forecast(naive(beer2, h=11), plot.conf=FALSE, series="Naïve") +
  geom_forecast(snaive(beer2, h=11), plot.conf=FALSE, series="Seasonal naïve") +
...
# Plot some forecasts
autoplot(dj2) + 
  geom_forecast(meanf(dj2, h=42), plot.conf=FALSE, series="Mean") +
  geom_forecast(rwf(dj2, h=42), plot.conf=FALSE, series="Naïve") +
  geom_forecast(rwf(dj2, drift=TRUE, h=42), plot.conf=FALSE, series="Drift") +
...
autoplot(window(ausbeer, start=1992)) +
  geom_forecast(beerfit1, series="Mean", plot.conf=FALSE) +
  geom_forecast(beerfit2, series="Naïve", plot.conf=FALSE) +
  geom_forecast(beerfit3, series="Seasonal naïve", plot.conf=FALSE) +
  xlab("Year") + ylab("Megalitres") +
  ggtitle("Forecasts for quarterly beer production")  + 
  guides(colour=guide_legend(title="Forecast"))
```
...
autoplot(dj) +
  geom_forecast(djfc1, plot.conf=FALSE, series="Mean") +
  geom_forecast(djfc2, plot.conf=FALSE, series="Naïve") +
  geom_forecast(djfc3, plot.conf=FALSE, series="Drift") +
  xlab("Day") + ylab("") +
  ggtitle("Dow Jones Index (daily ending 15 Jul 94)") +
  guides(colour=guide_legend(title="Forecast"))
```
