...
Figure \@ref(fig:ConsInc) shows time series of quarterly percentage changes (growth rates) of real personal consumption expenditure ($y$) and real personal disposable income ($x$) for the US from Q1 1960 to Dec 2016.
...
$$
  \hat{y}_t=`r coef(fit.cons)[1]` + `r coef(fit.cons)[2]`x_t.
$$
...
ggplot(as.data.frame(usconsumption), aes(x=income, y=consumption)) +
