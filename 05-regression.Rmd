...
```{r ConsInc, echo=TRUE, cache=TRUE, fig.cap="Quarterly percentage changes in real personal consumption expenditure and real personal disposable income for the US over the period 1960Q1-2016Q3."}
...
```{r usfitted2, echo=TRUE, cache=TRUE, fig.cap="Actual US consumtpion expenditure plotted against predicted US consumtpion expenditure.", message=FALSE, warning=FALSE}
...
May be add this as an exercise try `easter(ausbeer)` and interpret what you see.



## Evaluating the regression model {#Regr-EvaluatingSLR}

The difference between the observed $y$ values and the corresponding fitted $\hat{y}$ values are the in-sample forecast errors or "residuals" defined as
\begin{align*}
  e_t &= y_t - \hat{y}_t \\
