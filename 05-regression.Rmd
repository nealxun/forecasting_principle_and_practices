...
An attmept to improve the simple linear regression model considered in the US consumption expenditure example above would be to include more predictors in the model. Including other relevant predictors in the model will help capture more of the variation in the consumption data.

Building a multiple linear regression model may potentially generate more accurate forecasts as consumption expenditure does not only depend on personal income but other predictors as well. Figure \@ref(fig:MultiPredictors) shows three prossible predictors. These are quarterly percentage changes in industrial production and personal savings, and quarterly changes in the unemployment rate as this is already a percentage.

```{r MultiPredictors, echo=TRUE, cache=TRUE, fig.cap="Quarterly percentage changes in industrial production and personal savings and quarterly changes in the unemployment rate for the US."}
