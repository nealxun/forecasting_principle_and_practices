...
Predictions of $y_t$ can be obtained by ignoring the error in the regression equation and using the estimated coefficients. Hence, plugging in the values of $x_{1,t},\ldots,x_{k,t}$ for $t=1,\ldots,T$ into the regression equation
\begin{equation}
...
Each forecast for the change in consumtpion in \@ref(fig:ConsInc4) is surounded by a prediction interval. The general formulat How these are calculated are shown 
