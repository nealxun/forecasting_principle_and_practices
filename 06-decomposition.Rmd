...
```{r elecequip-stl, fig.cap="The electricial equipment orders (top) and its three additive components.", fig.width=8, fig.height=7, echo=FALSE}
...
```{r classical-elecequip, echo=TRUE, fig.width=8, fig.height=7, fig.cap="A classical multiplicative decomposition of the new orders index for electrical equipment."}
...
```{r x11, echo=TRUE, warning=FALSE, fig.width=8, fig.height=7, fig.cap="An X11 decomposition of the new orders index for electrical equipment."}
library(seasonal)
...
```{r seats, echo=TRUE, warning=FALSE, fig.width=8, fig.height=7, fig.cap="A SEATS decomposition of the new orders index for electrical equipment."}
library(seasonal)
fit <- seas(elecequip)
autoplot(fit) +
...
```{r elecequip-stl2, fig.cap="The electrical equipment orders (top) and its three additive components obtained from a robust STL decomposition with flexible trend-cycle and fixed seasonality.",fig.width=8, fig.height=7, echo=TRUE}
elecequip %>%
