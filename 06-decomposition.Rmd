...
autoplot(elecequip, series="Data") + 
  forecast:::ggts(trendcycle(fit), series="Trend-cycle") +
...
autoplot(elecequip, series="Data") + 
  forecast:::ggts(seasadj(fit), series="Seasonally Adjusted") +
  xlab("Year") + ylab("New orders index") +
  ggtitle("Electrical equipment manufacturing (Euro area)") +
...
autoplot(elecsales, series="Data") + 
  forecast:::ggts(ma(elecsales,5), series="5-MA") +
  xlab("Year") + ylab("GWh") +
  ggtitle("Annual electricity sales: South Australia") +
...
{
  autoplot(elecsales, series="Data") +
    forecast:::ggts(ma(elecsales, mak[m]), series="MA") + 
...
autoplot(elecequip, series="Data") + 
  forecast:::ggts(ma(elecequip, 12), series="12-MA") +
  xlab("Year") + ylab("New orders index") +
  ggtitle("Electrical equipment manufacturing (Euro area)") + 
...
autoplot(elecequip, series="Data") +
  forecast:::ggts(trendcycle(fit), series="Trend") +
  forecast:::ggts(seasadj(fit), series="Seasonally Adjusted") + 
  xlab("Year") + ylab("New orders index") +
  ggtitle("Electrical equipment manufacturing (Euro area)") +
