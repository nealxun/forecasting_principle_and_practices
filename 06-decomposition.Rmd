...
For example, Figure \@ref(fig:x13arima-seasadj) shows the trend-cycle component and the seasonally adjusted data, along with the original data.

```{r x13arima-seasadj, echo=TRUE, warning=FALSE, cache=TRUE, fig.cap="Electrical equipment orders: the original data (grey), the trend-cycle component (red) and the seasonally adjusted data (blue)."}
tmp <- cbind(
	Data=elecequip, 
...
```{r elecequip3, fig.cap="Seasonal sub-series plot of the seasonal component from the STL decomposition shown in Figure \\@ref(fig:elecequip-stl).", echo=TRUE, cache=FALSE}
