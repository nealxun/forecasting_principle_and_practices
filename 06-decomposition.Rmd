...
```{r elecequip3, fig.cap="Seasonal sub-series plot of the seasonal component from the X-13-ARIMA-SEATS decomposition shown in Figure \\@ref(fig:x13arima).", echo=TRUE, cache=TRUE}
