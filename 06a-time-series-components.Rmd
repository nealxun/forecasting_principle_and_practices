...
```{r 6-elecequip-stl, fig.cap="The electricial equipment orders (top) and its three additive components."}
autoplot(fit)
```
...
```{r 6-elecequip3, fig.cap="Seasonal sub-series plot of the seasonal component from the STL decomposition shown in Figure \\@ref(fig:6-elecequip-stl)."}
...
```{r 6-elecequip-sa, fig.cap="Seasonally adjusted electrical equipment orders (red) and the original data (grey)."}
