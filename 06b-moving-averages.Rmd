...
For example, consider Figure \@ref(fig:ressales1) showing the volume of electricity sold to residential customers in South Australia each year from 1989 to 2008 (hot water sales have been excluded). The data are also shown in Table \@ref(fig:elecsales).
...
# Show table
out <- knitr::kable(weights,digits=3,padding=0,
    booktabs=TRUE,
