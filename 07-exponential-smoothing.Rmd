...
```{r, include=FALSE}
tab <- rbind(
  c("(N,N)","Simple exponential smoothing"),
  c("(A,N)","Holt's linear method"),
  c("(Ad,N","Additive damped trend method"),
  c("(A,A)","Additive Holt-Winters method"),
  c("(A,M)","Multiplicative Holt-Winters method"),
  c("(Ad,M)","Holt-Winters damped method"))
knitr::kable(tab,booktabs=TRUE, col.names=c("",""))
```
