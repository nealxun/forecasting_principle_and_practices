...
autoplot(air) +
  ...
  autolayer(fc2, PI=FALSE, series="Damped Holt's method") +
...
autoplot(aust) +
  autolayer(fit1, PI=FALSE, series="HW additive forecasts") +
  autolayer(fit2, PI=FALSE, series="HW multiplicative forecasts") +
