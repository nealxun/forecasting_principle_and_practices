...
knitr::kable(tmp, booktabs=TRUE,
             caption="Applying Holt's linear method with $\\alpha=0.8000$ and $\\beta^*=0.0001$ to Australian air passenger data (millions of passengers).")
```

```{r checkholt, echo=FALSE, cache=FALSE}
if(sum(abs(fc$model$par[1:2] - c(0.8000,0.0001))) > 1e-4)
