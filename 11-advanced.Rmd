...
<!-- ?? Can we / should we simplify the above example with this below??  -->
...
- But even the beginning of the year does not match a Jan 1, 2014 is a Wedn 
-->
...
Daily electricity demand can be modelled as a function of temperature. As you may have seen on your electricity bill, more electricity is used on hot days due to air conditioning and on cold days due to heating. Daily data for are stored as `elecdaily` including total daily demand, an indicator variable for workdays (a workday is represented with 1, and a non-workday is represented with 0), and daily maximum temperatures. Because there is weekly seasonality, the frequency has been set to 7.
