...
Implementations of Croston's method with more facilities including parameter estimation are available in ????.

Models that deal with the count nature of the data are described in ????.Christou and Fokianos???
